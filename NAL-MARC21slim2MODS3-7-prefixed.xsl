...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <!-- Maintenance note: For each revision, change the content of <recordInfo><marc:recordOrigin> to reflect the new revision number.
	MARC21slim2MODS3-7
	┌ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ┐ 
	...
	Revision 1.106 - Added a xsl:when to deal with '#' and ' ' in $marc:leader19 and $controlField008-18 - ws 2014/12/19		
	...
	Revision 1.44 - Added <recordInfo><marc:recordOrigin> canned text about the version of this stylesheet 2009 ntra
    ...
    <xsl:template name="marcRecord">
        ...
        <typeOfResource>
            <xsl:if test="$marcLeader7 = 'c'">
                <xsl:attribute name="marc:collection">yes</xsl:attribute>
            </xsl:if>
            <xsl:if
    	...
    	<!-- 1.171 language of cataloging added controlField-008-35-37 -->
        <!-- language from 008-->
            ...
            <xsl:if test="
                ...
                <relatedItem>
                    ...
                    <xsl:for-each
                        ...
                        <!-- nal identifiers: 1.172 - @76X-@78X $o=other, $x=issn,$w=journal:id -->
                        ...
                        <xsl:apply-templates select="marc:subfield[@code = 'a']" mode="relatedItem914"/>
                        
                        
                        <!--  1.120 - @76X-78X$z -->
<!--                        <xsl:apply-templates select="marc:subfield[@code = 'z']" mode="relatedItem"/>-->
                        <!--1.173 NAL relatedPart is parsed into -->
                        <xsl:if test="@tag = '773'">
                                    ...
                                    <xsl:analyze-string select="." regex="(\d{{4,6}}.\w{{0,4}})(.+)">
                                        <xsl:matching-substring>
                                            ...
                                            <detail type="volume">
                                                <number>
                                                  <xsl:value-of
                                                  select="replace(substring-after(regex-group(2), 'v.'), '(\s)(\d+)(.*)', '$2')"
                                                  />
                                                </number>
                                                <caption>v.</caption>
                                            </detail>
                        ...
                        <!--  Call names  -->
                      <!--  <xsl:apply-templates select="parent::*[@tag != '914']/marc:subfield[@code = 'a']" mode="relatedItem"/>-->
                    </xsl:for-each>
                </relatedItem>
            </xsl:if>
            <!--<!-\- LC's related part -\->
            ...
            <xsl:if
                ...
                <relatedItem type="series">
                    ...
                    <xsl:for-each
                        ...
                        <name type="corporate">
                            <xsl:call-template name="xxx880"/>
                            <xsl:for-each select="parent::*[@tag != '914']/marc:subfield[@code = 'a']">
                                <namePart>
                                    <xsl:value-of select="."/>
                                </namePart>
                            </xsl:for-each>
    ...
    <xd:doc id="relatedIdentifierLocal" scope="component">
        <xd:desc> 1.168 - @76X-78X$z </xd:desc>
    </xd:doc>
    <xsl:template match="*[@tag = '914']/marc:subfield[@code='a']" mode="relatedItem914">
        <identifier type="local">
            <xsl:call-template name="xxs880"/>
            <xsl:value-of select="."/>   
        </identifier>
   ...
   <!-- <xd:doc id="relatedIdentifierLocal" scope="component">
    ...
    <xsl:template match="marc:subfield[@code = 'w'] | //marc:datafield[@tag = '914'][marc:subfield[@code='a']]" mode="relatedItem-w">
        <identifier type="local">
            ...
            <xsl:when test="../marc:subfield[@code='w']">
                ...
                <xsl:otherwise>
                    <xsl:for-each select="../marc:datafield[@tag='914'][current()]">
                        <xsl:value-of select="[marc:subfield[@code='a']]"/>
                    </xsl:for-each>
                </xsl:otherwise>
            </xsl:choose>
    ...
    <!-- 1.168 -->
    <xd:doc id="preventOtherRelatedItem" scope="component">
        <xd:desc>empty template to prevent other relatedItems</xd:desc>
    </xd:doc>
...
&lt;/xsl:template&gt;-->
    ...
    <xd:doc>
        <xd:desc>
            ...
            <xd:p>Contains 3 date instances of a marc:record:</xd:p>
            <xd:ul>
    ...
    <xsl:template name="originInfo">
        ...
        <xsl:variable name="originInfoShared">
            ...
            <!-- 1.173 for journal publisher to appear with article -->
                <xsl:for-each-group group-starting-with=".[current()]" select="//marc:datafield[@tag = '773']/marc:subfield[@code='d']">
                <publisher>
