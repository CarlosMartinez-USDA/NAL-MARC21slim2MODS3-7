...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <!-- includes -->
    <xsl:include href="NAL-MARC21slimUtils-conditionals.xsl"/>
    <xsl:include href="commons/functions.xsl"/>
    <xsl:include href="commons/params.xsl"/>

    <!-- outputs -->
    <xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" name="saxon"/>
    ...
    <xsl:template name="subfield-w">
    <identifer type="local">
        <xsl:value-of select="../marc:datafield[@tag = 914]/marc:subfield[@code='a']"/>
    </identifer>
    </xsl:template>
    ...
    <xsl:template match="marc:datafield[@tag = 914]/marc:subfield[@code='a']" mode="relatedItem-w">
        <identifier type="local">
            <xsl:call-template name="xxs880"/>
            <xsl:value-of select="marc:subfield[@code = 'a']"/>   
        </identifier>
...
<!--    <xd:doc id="relatedIdentifierLocal" scope="component">
    ...
    <xsl:template match="marc:subfield[@code = 'w'] | marc:datafield[@tag = '914']/marc:subfield[@code='a']" mode="relatedItem-w">
        <identifier type="local">
            <!-\- 1.168 -\->
            <xsl:choose>
                <xsl:when test="count(../marc:subfield[@code='w']) = 0">
                <xsl:call-template name="xxs880"/>
                <xsl:apply-templates/>
            </xsl:when>
                <xsl:otherwise>
...
<!--    <xd:doc id="relatedIdentifierLocal" scope="component">
    ...
    <xsl:template match="marc:subfield[@code = 'w'] | *[@tag = '914']/marc:subfield[@code = 'a']" mode="relatedItem-w">
        <identifier type="local">
          <xsl:choose>
              <xsl:when test="count(marc:subfield[@code='w']) != 0">
            <!-\- 1.121 -\->
            ...
            <xsl:apply-templates/>
              ...
              <xsl:otherwise>
            <!-\- 1.168 -\->
                 <xsl:for-each-group select="datafield[@tag = '914']" group-starting-with=".[current()]">
                      <xsl:value-of select="*[@tag = '914']/marc:subfield[@code = 'a']"/>
                 </xsl:for-each-group>
              </xsl:otherwise>
          </xsl:choose>
        </identifier>
    ...
    <xd:doc id="isInvalid" scope="component">
