...
-->
    ...
    <xd:doc scope="stylesheet" id="nal-local-functions">        
        <xd:desc>
            ...
            <xd:p>
                <xd:ul>
                    <xd:li><xd:i>1.<xd:ref name="f:add-namespace-prefix" type="function"></xd:ref>f:add-namespace-prefix</xd:i></xd:li>
                    ...
                    <xd:li><xd:i>4.<xd:ref name="f:nal:isoTwo2Lang" type="function"></xd:ref>f:isoTwo2Lang</xd:i></xd:li>
                    ...
                    <xd:li><xd:i>8.<xd:ref name="f:nal:proper-case" type="function"></xd:ref>f:nal:proper-case</xd:i></xd:li>
        ...
        <xsl:for-each select="$elements">
            ...
            <xsl:choose>
                ...
                <xsl:when test="$element instance of document-node()">
                    <xsl:document>
                        <xsl:sequence select="f:add-namespace-prefix(
 ...
 <xd:doc id="f:decodeMARCCountry" scope="component">
    ...
    <xd:doc>
        <xd:desc>
            ...
            <xd:p><xd:b>Purpose:</xd:b>The nal:sentence-case function  treats a string like
