...
-->
    ...
    <xd:doc scope="stylesheet" id="nal-local-functions">        
        <xd:desc>
            ...
            <xd:p><xd:b>NAL Custom XSLT Functions:</xd:b></xd:p>
            <xd:p>
                <xd:ul>
                    <xd:li><xd:i>1.<xd:ref name="f:add-namespace-and-prefix" type="function"></xd:ref>f:add-namespace-prefix</xd:i></xd:li>
                    <xd:li><xd:i>2.<xd:ref name="f:subjCatCode" type="function"></xd:ref>f:subjCatCode</xd:i></xd:li>
                    <xd:li><xd:i>3.<xd:ref name="f:decodeMARCCountry" type="function"></xd:ref>f:decodeMARCCountry</xd:i></xd:li>
                    <xd:li><xd:i>4.<xd:ref name="f:f:isoTwo2Lang" type="function"></xd:ref>f:isoTwo2Lang</xd:i></xd:li>
                    <xd:li><xd:i>5.<xd:ref name="f:isoOne2Two" type="function"></xd:ref>f:isoOne2Two</xd:i></xd:li>
                    <xd:li><xd:i>6.<xd:ref name="f:capitalize-first" type="function"></xd:ref>f:capitalize-first</xd:i></xd:li>
                    <xd:li><xd:i>7.<xd:ref name="f:sentence-case" type="function"></xd:ref>f:sentence-case</xd:i></xd:li>
                    <xd:li><xd:i>8.<xd:ref name="f:f:proper-case" type="function"></xd:ref>f:f:proper-case</xd:i></xd:li>
                    <xd:li><xd:i>9.<xd:ref name="f:nameIdentifier" type="function"></xd:ref>f:nameIdentifier</xd:i></xd:li>
                </xd:ul>     
            </xd:p>
        </xd:desc>
    ...
    <xd:doc id="f:add-namespace-and-prefix" scope="component">
        <xd:desc>
            ...
            <xd:p><xd:b>Purpose: </xd:b>Change namespace of $elements, but </xd:p>
        </xd:desc>
                ...
                <xsl:when test="$element instance of element()">
                    <xsl:element name="{concat($prefix,
                        ...
                        <xsl:sequence select="($element/@*,
                            f:add-namespace-and-prefix($element/node(),
                            $namespace, $prefix))"/>
                    </xsl:element>
                </xsl:when>
            <xsl:when test="$element instance of document-node()">
                <xsl:document>
                    <xsl:sequence select="f:add-namespace-and-prefix(
                        $element/node(), $namespace, $prefix)"/>
                </xsl:document>
            </xsl:when>
            </xsl:choose>
        </xsl:for-each>        
    ...
    <xsl:function name="f:add-namespace-and-prefix" as="node()*"
        xmlns:f="http://functions">
 ...
 <xd:doc id="f:decodeMARCCountry" scope="component">
    ...
    <xsl:function name="f:tokenize-chars" xmlns:f="http://functions">
        <xsl:param name="arg" as="xs:string?"/>
        <xsl:variable name="tokenized-chars" select="tokenize($arg,',. ')"/>
        <xsl:variable name="substring1" select="substring-before($arg, $tokenized-chars)"/>
        <xsl:variable name="substring2" select="substring-after($arg, $tokenized-chars)"/>
        <xsl:sequence select="
            if (contains($arg, $tokenized-chars))
            then concat(f:sentence-case($substring1), ($tokenized-chars), (f:sentence-case($substring2)))
            else f:sentence-case($arg)"
        />
    </xsl:function>
    ...
    <xd:doc>
        <xd:desc>
            ...
            <xd:p><xd:b>Purpose: </xd:b>The f:nameIdentifier creates the mods:nameIndentifier @type attribute's label. 
                The function takes an xpath expression provided as the $arg parameter. 
                First fn:matches($arg, $regex) tests the $arg.
                If $arg matches the $regex, then fn:replace($arg, $regex, $flag).
                The same procedure is repeated for more complex URI's </xd:p> 
